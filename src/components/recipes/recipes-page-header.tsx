...
const RecipesPageHeader: React.FC<RecipesPageHeaderProps> = () => {
  ...
  return (
    <div className="sticky top-0 z-[15] border border-border/60 dark:border-border/80 divide-border/60 dark:divide-border/80 ring-border dark:ring-border bg-background dark:bg-background rounded-tl-lg rounded-tr-lg">
